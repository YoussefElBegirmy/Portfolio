...
export interface Certification {
  ...
  description?: string;
  badge: string; // Path relative to the 'public' folder
...
export const CertificationsData: Certification[] = [
  {
    ...
    badge: '/images/badges/Microsoft.PNG', // CORRECTED CASE: Matches GitHub screenshot
  ...
  },
  {
    ...
    badge: '/images/badges/coursera.jpeg', // Matches GitHub screenshot
  ...
  },
  {
    ...
    badge: '/images/badges/ITI_Iot.jpeg', // Matches GitHub screenshot
